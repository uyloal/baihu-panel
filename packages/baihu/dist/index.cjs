...
async function updateEnv(id, name, value, remark, type, hidden, enabled) {
  const payload = {};
...
module.exports = baihu;
module.exports.notify = notify;
module.exports.getEnvs = getEnvs;
module.exports.getEnv = getEnv;
module.exports.addEnvs = addEnvs;
module.exports.addEnv = addEnv;
module.exports.updateEnv = updateEnv;
module.exports.deleteEnvs = deleteEnvs;
